...
const injectedRtkApi = api
  ...
  .injectEndpoints({
    endpoints: (build) => ({
      ...
      getCheckStatus: build.query<GetCheckStatusApiResponse, GetCheckStatusApiArg>({
        query: (queryArg) => ({
          url: `/checks/${queryArg.name}/status`,
          params: {
            pretty: queryArg.pretty,
          },
        }),
      ...
      replaceCheckStatus: build.mutation<ReplaceCheckStatusApiResponse, ReplaceCheckStatusApiArg>({
        query: (queryArg) => ({
          url: `/checks/${queryArg.name}/status`,
          method: 'PUT',
          body: queryArg.check,
      ...
      updateCheckStatus: build.mutation<UpdateCheckStatusApiResponse, UpdateCheckStatusApiArg>({
        query: (queryArg) => ({
          url: `/checks/${queryArg.name}/status`,
          method: 'PATCH',
          body: queryArg.patch,
      ...
      getCheckTypeStatus: build.query<GetCheckTypeStatusApiResponse, GetCheckTypeStatusApiArg>({
        query: (queryArg) => ({
          url: `/checktypes/${queryArg.name}/status`,
          params: {
            pretty: queryArg.pretty,
          },
        }),
      ...
      replaceCheckTypeStatus: build.mutation<ReplaceCheckTypeStatusApiResponse, ReplaceCheckTypeStatusApiArg>({
        query: (queryArg) => ({
          url: `/checktypes/${queryArg.name}/status`,
          method: 'PUT',
          body: queryArg.checkType,
      ...
      updateCheckTypeStatus: build.mutation<UpdateCheckTypeStatusApiResponse, UpdateCheckTypeStatusApiArg>({
        query: (queryArg) => ({
          url: `/checktypes/${queryArg.name}/status`,
          method: 'PATCH',
          body: queryArg.patch,
...
export type GetCheckStatusApiResponse = /** status 200 OK */ Check;
export type GetCheckStatusApiArg = {
  /** name of the Check */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
};
export type ReplaceCheckStatusApiResponse = /** status 200 OK */ Check | /** status 201 Created */ Check;
export type ReplaceCheckStatusApiArg = {
  /** name of the Check */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
...
export type UpdateCheckStatusApiResponse = /** status 200 OK */ Check | /** status 201 Created */ Check;
export type UpdateCheckStatusApiArg = {
  /** name of the Check */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
...
export type GetCheckTypeStatusApiResponse = /** status 200 OK */ CheckType;
export type GetCheckTypeStatusApiArg = {
  /** name of the CheckType */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
};
export type ReplaceCheckTypeStatusApiResponse = /** status 200 OK */ CheckType | /** status 201 Created */ CheckType;
export type ReplaceCheckTypeStatusApiArg = {
  /** name of the CheckType */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
...
export type UpdateCheckTypeStatusApiResponse = /** status 200 OK */ CheckType | /** status 201 Created */ CheckType;
export type UpdateCheckTypeStatusApiArg = {
  /** name of the CheckType */
  name: string;
  /** If 'true', then the output is pretty printed. Defaults to 'false' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). */
  pretty?: string;
